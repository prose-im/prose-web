...
<template lang="pug">
svg(@click="$emit('click')" xmlns="http://www.w3.org/2000/svg", width="24", height="24", viewBox="0 0 32 32", class="menu-to-close-wrapper")
    title menu to close
    g(stroke-linecap="round", stroke-linejoin="round", stroke-width="2", fill="currentColor", stroke="currentColor")
        g.js-nc-int-icon.nc-int-menu-to-close(:class="{ 'nc-int-icon-state-b': isOpen }")
